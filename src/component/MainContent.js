...
import VideoToolsImg from "../assest/images/VideoToolsImg.jpg";
import AudioToolsImg from "../assest/images/audioTools.png";
...
function MainContent({ selectedComponent, setSelectedComponent }) {
  ...
  const components = {
    pdfConversion: (
      <PdfToPngConverter onClose={() => setSelectedComponent(null)} />
    ),
    login: <LoginSignupForm closeForm={() => setSelectedComponent(null)} />,
    ...
    addAudioToVideo: (
      <AddAudioToVideo onClose={() => setSelectedComponent(null)} />
    ),
    addImageToVideo: (
      <AddImageToVideo onClose={() => setSelectedComponent(null)} />
    ),
    addTextToVideo: (
      <AddTextToVideo onClose={() => setSelectedComponent(null)} />
    ),
    ...
    videoConversion: (
      <VideoConversion onClose={() => setSelectedComponent(null)} />
    ),
    screenRecorder: (
      <ScreenRecorder onClose={() => setSelectedComponent(null)} />
    ),
    textToSpeech: <TextToSpeech onClose={() => setSelectedComponent(null)} />,
    mergeVideos: <MergeVideos onClose={() => setSelectedComponent(null)} />,
    removeLogoFromVideo: (
      <RemoveLogoFromVideo onClose={() => setSelectedComponent(null)} />
    ),
    ...
    changeAudioVolume: (
      <ChangeAudioVolume onClose={() => setSelectedComponent(null)} />
    ),
    changeAudioSpeed: (
      <ChangeAudioSpeed onClose={() => setSelectedComponent(null)} />
    ),
    changeAudioPitch: (
      <ChangeAudioPitch onClose={() => setSelectedComponent(null)} />
    ),
      ...
      {selectedComponent ? (
        ...
        <>
          <div
            ...
            onClick={() => setSelectedComponent("pdfConversion")}
            ref={refMap.pdfConversion}
          >
            <img src={Convert} alt="Convert" className="img1" />
            <h2>PDF Conversion</h2>
            <p>
              Convert your documents to and from PDF format effortlessly.
              Supported formats include Word, Excel, PowerPoint, and more.
            </p>
          </div>

          <div
            className="Merge"
            onClick={() => setSelectedComponent("mergePdf")}
            ref={refMap.mergePdf}
          >
            <img src={MergeImg} alt="Merge" className="img2" />
            <h2>Merge PDFs</h2>
            <p>
              Easily merge multiple PDF files into a single document or split a
              large PDF into smaller files.
            </p>
          </div>

          <div
            className="Compress"
            onClick={() => setSelectedComponent("fileCompressor")}
            ref={refMap.fileCompressor}
          >
          ...
          <div
            className="EditImg"
            onClick={() => setSelectedComponent("editImage")}
            ref={refMap.editImage}
          >
          ...
          <div
            className="SecurePdf"
            onClick={() => setSelectedComponent("securePdf")}
            ref={refMap.securePdf}
          >
            <img src={SecureImg} alt="Secure" className="img5" />
            <h2>Secure PDFs</h2>
            <p>
              Add passwords, permissions, and other security features to your
              PDF files.
            </p>
          </div>
          ...
          <div
            ...
            onClick={() => setSelectedComponent("imageToPdf")}
            ref={refMap.imageToPdf}
          >
            <img src={PdfImg} alt="Image to PDF" className="img6" />
            <h2>Image to PDF</h2>
            <p>Convert images into PDF files for easy sharing and archiving.</p>
          </div>

          <div
            className="PptToPdf"
            onClick={() => setSelectedComponent("pdfToPpt")}
            ref={refMap.pdfToPpt}
          >
            <img src={PptImg} alt="PPT to PDF" className="img7" />
            <h2>PPT to PDF</h2>
            <p>
              Convert PowerPoint presentations into PDF format for easier
              distribution.
            </p>
          </div>
          ...
          <div
            className="RotatePdf"
            onClick={() => setSelectedComponent("rotatePdf")}
            ref={refMap.rotatePdf}
          >
            <img src={RotateImg} alt="Rotate PDF" className="img8" />
            <h2>Rotate PDFs</h2>
            <p>
              Rotate pages within a PDF document to correct orientation issues.
            </p>
          </div>

          <div
            className="VideoTools"
            onClick={() => setSelectedComponent("videoConversion")}
            ref={refMap.videoConversion}
          >
            <img src={VideoToolsImg} alt="Video Tools" className="img9" />
            <h2>Video Tools</h2>
            <p>Explore various video editing and conversion tools.</p>
          </div>

          <div
            className="AudioTools"
            onClick={() => setSelectedComponent("audioJoiner")}
            ref={refMap.audioJoiner}
          >
            <img src={AudioToolsImg} alt="Audio Tools" className="img10" />
            <h2>Audio Tools</h2>
            <p>Find tools for editing and enhancing audio files.</p>
          </div>
        </>
      )}
    </section>
